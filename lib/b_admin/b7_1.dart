...
class _B7_1State extends State<B7_1> {
  ...
  List<List<Child>> childListByClass = [];
  ...
  getChildInfo() async {
    http.Response childRes =
        await api(apiUrl.child, 'get', 'signInToken', {}, context);
    if (childRes.statusCode == 200) {
      ...
      for (int i = 0; i < childData.length; i++) {
        ...
        classKind.add(childData[i]['className']);
      }
      classKindList = classKind.toList();
      for (int i = 0; i < classKindList.length; i++) {
        childListByClass.add([]);
        classNumber.add(i);
        for (int j = 0; j < childData.length; j++) {
          if (classKindList[i] == childData[j]['className']) {
            childListByClass[i].add(
                Provider.of<ChildDataManagement>(context, listen: false)
                    .childList[j] );
          }
        }
      ...
      setState(() {
        ...
        classKindList.add('전체');
        classNumber.add(classKindList.length - 1);
        classFilter = classKindList.length - 1;
        childLoading = true;
      });
      setState(() {
        if (sort != 0) {
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              if (reverse[0]) {
                                setState(() {
                                  if(classFilter == classKindList.length -1){
                                  Provider.of<ChildDataManagement>(context,
                                  listen: false)
                                      .childList
                                      .sort((a, b) => a.name.compareTo(b.name));
                                  }else{
                                    childListByClass[classFilter].sort((a, b) => a.name.compareTo(b.name));
                                  }
                                  reverse[0] = !reverse[0];
                                  sort = 1;
                                });
                                ...
                                setState(() {
                                  if(classFilter == classKindList.length -1){
                                    ...
                                    childListByClass[classFilter].sort((a, b) => b.name.compareTo(a.name));
                                  }
                                  reverse[0] = !reverse[0];
                                  sort = 1;
                                });
                              ...
                              if (reverse[1]) {
                                setState(() {
                                  if(classFilter == classKindList.length -1){
                                    ...
                                    childListByClass[classFilter].sort((a, b) => a.birthday.compareTo(b.birthday));
                                  }
                                  reverse[1] = !reverse[1];
                                  sort = 2;
                                });
                                ...
                                setState(() {
                                  if(classFilter == classKindList.length -1){
                                    ...
                                    childListByClass[classFilter].sort((a, b) => b.birthday.compareTo(a.birthday));
                                  }
                                  reverse[1] = !reverse[1];
                                  sort = 2;
                                });
                              ...
                              if (reverse[2]) {
                                setState(() {
                                  if(classFilter == classKindList.length -1){
                                    ...
                                    childListByClass[classFilter].sort((a, b) => a.className.compareTo(b.className));
                                  }
                                  reverse[2] = !reverse[2];
                                  sort = 3;
                                });
                                ...
                                setState(() {
                                  if(classFilter == classKindList.length -1){
                                    Provider.of<ChildDataManagement>(context,
                                        listen: false)
                                        .childList
                                        .sort((a, b) => b.className.compareTo(a.className));
                                  }else{
                                    childListByClass[classFilter].sort((a, b) => b.className.compareTo(a.className));
                                  }
                                  reverse[2] = !reverse[2];
                                  sort = 3;
                                });
                            ...
                            child: ListView(
                                ...
                                children: [
                                  if(classFilter == classKindList.length -1)...[
                                    ...
                                    if(childListByClass.isNotEmpty)...[
                                      for (int i = 0;
                                      i <
                                          childListByClass[classFilter].length;
                                      i++) ...[
                                        ChildListRow(
                                          relation:
                                          childListByClass[classFilter][i]
                                              .relation,
                                          birthday:
                                          childListByClass[classFilter][i]
                                              .birthday,
                                          ...
                                          childListByClass[classFilter][i]
                                              .parentName,
                                          comment: childListByClass[classFilter][i]
                                              .comment,
                                          name: childListByClass[classFilter][i]
                                              .name,
                                        )
                                      ]
                                    ]
...
class _MakeChildRowState extends State<MakeChildRow> {
  ...
  void initState() {
    ...
    if (Provider.of<ClassDataManagement>(context, listen: false)
            .classList
            .length ==
        0) {
      number.add(0);
      className.add(Provider.of<UserInfo>(context, listen: false).value[2]);
      cId.add(Provider.of<UserInfo>(context, listen: false).value[0]);
...
class _ModifyChildDialogState extends State<ModifyChildDialog> {
  ...
  void initState() {
    ...
    // for(int i = 0; i<Provider.of<ClassDataManagement>(context, listen: false).classList.length;i++){
    //
    // }
    // TODO: implement initState
    super.initState();
